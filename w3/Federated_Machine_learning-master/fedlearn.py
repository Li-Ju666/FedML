...
def load_data():
    ...
    data = pd.read_csv(r"/home/sariel/PycharmProjects/fedml/FedML/w3/Federated_Machine_learning-master/data/weatherHistory.csv", header=None)
...
<<<<<<< HEAD
        ...
        print("Global models loss: %.2f" % mae)
=======
